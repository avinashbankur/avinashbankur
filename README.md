...
Implemented an ASIC physical design flow for a PicoRV32 RISC-V processor, covering the complete RTL-to-GDSII implementation flow.
...
OpenLane • OpenROAD • SKY130 • LEF/DEF • Static Timing Analysis
...
Developed a machine-learning-based biometric authorization system with face detection, authorization and deepfake classification.

<br>

**Technologies**

Python • TensorFlow Lite • OpenCV • FaceForensics++ • IRIS
...
Developed a Raspberry Pi-based IoT safety robot for real-time threat detection, GPS tracking and emergency alerts.

<br>

**Technologies**

Raspberry Pi • Python • GPS • GSM • Sensors
...
Built a collision detection system that automatically detects accidents and sends real-time alerts with location details.

<br>

**Technologies**

Arduino • GPS • GSM • Sensors
...
Performed data cleaning, preprocessing, exploratory data analysis, feature engineering, outlier analysis and correlation analysis.
...
Built Library Management and Banking Management applications using object-oriented programming and persistent file-based data storage.
...
Digital Electronics • VLSI Design • Embedded Systems • Communication Systems • Computer Networks • Signals & Systems • IoT
